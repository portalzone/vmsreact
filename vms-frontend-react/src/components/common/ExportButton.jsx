...
const ExportButton = ({ data, filename, sheetName = 'Data', formatData, className = '' }) => {
  ...
  const handleExport = async () => {
    ...
    try {
      // Format data if formatter function provided
      const dataToExport = formatData ? formatData(data) : data;
      
      const success = exportToExcel(dataToExport, filename, sheetName);
